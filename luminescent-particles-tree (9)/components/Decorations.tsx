...
export const SnowParticles: React.FC<SnowParticlesProps> = ({ mode }) => {
    ...
    useFrame(() => {
        ...
        // Note: Rotation modes don't affect snow physics anymore, 
        // as the entire scene rotates.
        if (mode === 'frozen') {
            speedMultiplier = 0;
        } else if (mode === 'fast') {
            speedMultiplier = 4.0;
